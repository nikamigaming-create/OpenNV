...
class Fo1DestinationReturnExitTest(unittest.TestCase):
 ...
 def test_runtime_restores_only_the_hash_bound_v13ent_map_after_committed_return(self):
  session=read_csharp_source_module((FO1/'Fo1TacticalSession.cs'));flow=read_csharp_source_module((FO1/'Fo1NewGameFlow.cs'));coord=read_csharp_source_module((ROOT/'runtime'/'src'/'RuntimeCoordinator.cs'))
