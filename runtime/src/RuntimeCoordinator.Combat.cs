...
public partial class RuntimeCoordinator
{
    ...
    private NativeActorCombatContext NativeCombatContext => _nativeCombatContext ??= new(
        ...
        (amount, part, limbMultiplier) => _nativeOpeningStageDriver!.DamagePlayer(amount, part, limbMultiplier),
        (from, to) => FindNativeNavigationRoute(new(from.X, from.Y, from.Z), new(to.X, to.Y, to.Z))
