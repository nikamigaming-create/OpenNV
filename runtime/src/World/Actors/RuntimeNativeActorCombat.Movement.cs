...
internal sealed partial class RuntimeNativeActorCombat
{
    ...
    private object MotionObservation => new { radius = _radius, waypoints = _pursuitPath.Length, cursor = _pursuitCursor,
        blocked = _movementBlock, source = "source-BBX-envelope,KF-accumulation,NAVM;Godot-capsule-and-step-resolver" };
    ...
    private void PrepareMovement()
    {
        ...
        {
            Name = "SourceActorMovementEnvelope", Position = Vector3.Up * height / 2,
