...
internal partial class OpeningQuestRuntime : CanvasLayer
{
    ...
    private const int FightingControlIndex = 1;
    private const int PointOfViewControlIndex = 2;
    private const int LookingControlIndex = 3;
    private const int SneakingControlIndex = 4;
    private const int MenuControlIndex = 5;
    private const int ActivationControlIndex = 6;
