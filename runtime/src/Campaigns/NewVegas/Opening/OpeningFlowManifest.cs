    ...
    OpeningCharacterCreation Character)
{
    ...
    private const string RoutePlayerFaceGenPreviewStatus =
    ...
    private const string RoutePlayerFaceGenPreviewRuntimeDisposition =
    ...
    private const string RoutePlayerFaceGenPreviewSelectionScope =
        "source-default-player-identity-route-validation";
    private const string RoutePlayerFaceGenUnsupportedSelectionScope =
    ...
    private static OpeningGuideLocation ParseGuideLocation(JsonElement source) => new(
        ...
        source.GetProperty("reference") is { ValueKind: JsonValueKind.Object } reference
            ? new OpeningGuideReference(
                ...
                OptionalString(reference, "cellFormId"),
