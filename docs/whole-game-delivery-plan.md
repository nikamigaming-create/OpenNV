...
| Doc Mitchell house/Goodsprings exterior/saloon ordered route | Current r25 configured-input traversal/save and cold Continue pass against the admitted four-family cache; campaign save v6 owns source-derived vitals, CELL `00106185`, containers, and player transform. The active-CELL WorldEnvironment/sky owner restores interior XCLL background/fog and renders the owned configured clear-day WTHR atmosphere/cloud pair outside. Exterior surface/directional lighting remains provisional; dynamic time/weather, player deposits, reverse traversal, neighboring exterior-grid streaming, integrated OpenXR, and Sunny behavior remain pending | [Normal-menu Goodsprings route](evidence/fnv-normal-menu-goodsprings-route-contract.md) |
| Owned Fallout 3 menu, intro, CG00 character creation, and bounded birth room through persistent stage 100 | `interactive frontend`, not a freely playable presentation; exact stage-65/80/85/90 results, cue/fade/sound, seven of eight stage-100 commands, and cold restore work, while CG01 stage 0, the eighth command, general package/dialogue/KF AI, wider Vault 101 world play, Hex, and VR remain pending | [Multi-game first slices](multi-game-first-slices.md) |
