...
| Doc Mitchell house/Goodsprings exterior/saloon ordered route | Forward flat traversal/save evidence exists and campaign save v6 owns source-derived vitals, CELL `00106185`, containers, and player transform. Current-plus-direct-neighbors lifecycle has a direct native proof, but normal restore rejects that older compiler identity until migration/reacceptance; player deposits, reverse traversal, neighboring exterior-grid streaming, integrated OpenXR, and Sunny behavior remain pending | [Normal-menu Goodsprings route](evidence/fnv-normal-menu-goodsprings-route-contract.md) |
| Owned Fallout 3 menu, intro, CG00 character creation, and bounded birth room through persistent stage 90 | `interactive frontend`, not a freely playable presentation; exact stage-65/80/85/90 results, cue/fade/sound, and cold restore work, while general package/dialogue/KF AI, timer-to-stage-100, wider Vault 101 world play, Hex, and VR remain pending | [Multi-game first slices](multi-game-first-slices.md) |
