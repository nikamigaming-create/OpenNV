...
| Owned Fallout 2 character/Temple/Arroyo Caves route | `interactive bounded Hex launcher slice`; premade Take plus source-backed Modify/Create for name/sex/age/exact SPECIAL, sex-correct tile-28707 handoff, movement, and version-2 atomic male/female cold restore work; tag/trait editing, campaign-wide persistence, scripts/actors/combat/inventory, reciprocal exits, full campaign, FPS/OpenXR, and parity remain pending | [Multi-game first slices](multi-game-first-slices.md) |
