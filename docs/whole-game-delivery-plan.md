...
| Owned Fallout 2 character/Temple/Arroyo Caves route | `interactive bounded Hex launcher slice`; original owned picker plus distinct Narg/Mingan/Chitsa panels and one portrait/live curved-3D-panel toggle, premade Take plus source-backed Modify/Create for name/sex/age/exact SPECIAL, exact Map 3 exit serial 1738 into ARTEMPLE Map 126, and version-5 atomic appearance/gameplay cold restore. One strict MAP/PRO/MSG-bound Villager exposes player HP/AP, deterministic adjacent melee, defeat, exact nested Spear loot, visible inventory, and cold restore. Rebuilt head geometry, custom face/hair/skin editing, deterministic custom portrait generation, target AI/turns, INT/dialogue, general combat/inventory, campaign-wide persistence, full campaign, FPS/OpenXR, and parity remain pending | [Multi-game first slices](multi-game-first-slices.md) |
