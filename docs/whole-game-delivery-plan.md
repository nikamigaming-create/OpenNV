...
| Owned Fallout 2 premade/Temple/Arroyo Caves route | `interactive bounded Hex launcher slice`; exact Map 126/Map 3 local caches, owned Narg/Mingan/Chitsa selection, Take handoff to tile 28707, sex-correct idle FRM, source-walk-gated movement, and atomic cold restore work; Modify/Create, editable fields, campaign-wide persistence, scripts/actors/combat/inventory, reciprocal exits, full campaign, FPS/OpenXR, and parity remain pending | [Multi-game first slices](multi-game-first-slices.md) |
