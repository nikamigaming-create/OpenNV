...
- Its cell-child graph contains 452 REFR records; the dense bounded recipe
  selects 251 yaw-safe visible references backed by 117 unique NIF assets and
  excludes 50 unproven non-yaw placements.
...
- `Fallout - Textures.bsa` SHA-256
  ...
  supply 194 exact recipe texture members. They decode into hash-pinned PNGs and
  bind 274 source surfaces; the actor-free Forward+ capture retains the no-control
