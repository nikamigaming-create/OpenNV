...
| Travel | Source doors, a moving exterior grid, LAND/LOD and retained reference state are connected. Source-portal A* uses native player-capsule clearance and bounded replanning. | The flat bot completed the Primm approach and entered Nash Residence. Both modes opened ED-E's real repair menu. Repair/recruitment, following, complete routes and streaming spikes remain open. |
