...
| Audio/rendering | Source voices, animation, material/effect clocks, impacts and casings have runtime owners. Cloud rates now include weather wind and winning GMST speed. | All 98 loaded weather declarations pass; fresh corrected flat clouds were inspected. Tumbleweed wind forces remain unimplemented despite their source wind flag. Distant water, moving LOD/streaming, broader alpha, sound mix and matched final pixels remain incomplete. |
